                ...
                <div class="card-body">
                    ...
                    @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_num" type="text" class="form-control @error('phone_num') is-invalid @enderror" name="phone_num" value="{{ $user->phone_num }}" autocomplete="phone_num" autofocus>
